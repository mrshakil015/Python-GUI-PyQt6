# Form implementation generated from reading ui file 'CSVAnalysisWidget.ui'
#
...
"")
        ...
        self.logo_name_btn = QtWidgets.QPushButton(parent=self.frame_8)
        font = QtGui.QFont()
        font.setFamily("Arial Black")
        font.setPointSize(10)
        font.setBold(False)
        self.logo_name_btn.setFont(font)
        self.logo_name_btn.setStyleSheet("color: #0a676c;")
        self.logo_name_btn.setObjectName("logo_name_btn")
        self.horizontalLayout_6.addWidget(self.logo_name_btn)
        ...
        self.new_chat_btn = QtWidgets.QPushButton(parent=self.frame)
        font = QtGui.QFont()
        font.setBold(True)
        self.new_chat_btn.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../icons/paperclip.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.clear_history_btn = QtWidgets.QPushButton(parent=self.frame_4)
        ...
        self.logout_btn = QtWidgets.QPushButton(parent=self.frame_7)
        ...
        self.profile_btn = QtWidgets.QPushButton(parent=self.frame_11)
        ...
        self.gridLayout_11.addWidget(self.profile_btn, 0, 0, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 638, 511))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logo_name_btn.setText(_translate("MainWindow", "SOBJANTA"))
        self.new_chat_btn.setText(_translate("MainWindow", "Drop PDF Here"))
        ...
        self.input_textEdit.setPlaceholderText(_translate("MainWindow", "Ask any question..."))
