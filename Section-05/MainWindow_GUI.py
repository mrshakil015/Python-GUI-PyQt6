...
# Form implementation generated from reading ui file 'c:\Users\MD. SHAMIM\Documents\GitHub\Python-GUI-PyQt6\Section-05\MainGUI.ui'
#
# Created by: PyQt6 UI code generator 6.4.2
#
# WARNING: Any manual changes made to this file will be lost when pyuic6 is
...
"}")
        ...
        self.lineEdit_bookid.setMaximumSize(QtCore.QSize(16777215, 40))
        self.lineEdit_bookid.setObjectName("lineEdit_bookid")
        self.lineEdit_bookid.setStyleSheet("QLineEdit {border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white;}")
        self.verticalLayout_3.addWidget(self.lineEdit_bookid)
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")


        self.label_bookname_2 = QtWidgets.QLabel(parent=self.horizontalWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_bookname_2.setFont(font)
        self.label_bookname_2.setObjectName("label_bookname_2")
        self.horizontalLayout_6.addWidget(self.label_bookname_2)
        self.label_bookname = QtWidgets.QLabel(parent=self.horizontalWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_bookname.setFont(font)
        ...
        self.label_bookname.setObjectName("label_bookname")
        self.horizontalLayout_6.addWidget(self.label_bookname)
        self.verticalLayout_3.addLayout(self.horizontalLayout_6)
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")


        self.label_bookauthor_2 = QtWidgets.QLabel(parent=self.horizontalWidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_bookauthor_2.setFont(font)
        self.label_bookauthor_2.setObjectName("label_bookauthor_2")
        self.horizontalLayout_7.addWidget(self.label_bookauthor_2)
        ...
        self.label_bookauthor.setObjectName("label_bookauthor")
        self.horizontalLayout_7.addWidget(self.label_bookauthor)
...
"}")
        ...
        self.lineEdit_memberid.setMaximumSize(QtCore.QSize(16777215, 40))
        self.lineEdit_memberid.setObjectName("lineEdit_memberid")
        self.lineEdit_memberid.setStyleSheet("QLineEdit {border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white;}")
        self.verticalLayout_2.addWidget(self.lineEdit_memberid)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")


        self.label_membername_2 = QtWidgets.QLabel(parent=self.horizontalWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_membername_2.setFont(font)
        self.label_membername_2.setObjectName("label_membername_2")
        self.horizontalLayout_2.addWidget(self.label_membername_2)
        ...
        font.setPointSize(10)
        self.label_membername.setFont(font)
        self.label_membername.setText("")
        self.label_membername.setObjectName("label_membername")
        self.horizontalLayout_2.addWidget(self.label_membername)
        self.verticalLayout_2.addLayout(self.horizontalLayout_2)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")


        self.label_contactinfo_2 = QtWidgets.QLabel(parent=self.horizontalWidget_2)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        self.label_contactinfo_2.setFont(font)
        self.label_contactinfo_2.setObjectName("label_contactinfo_2")
        self.horizontalLayout_3.addWidget(self.label_contactinfo_2)
        ...
        self.label_contactinfo.setObjectName("label_contactinfo")
        self.horizontalLayout_3.addWidget(self.label_contactinfo)
...
"}")    
        ...
        self.lineEdit_submission.setObjectName("lineEdit_submission")
        self.lineEdit_submission.setStyleSheet("QLineEdit {border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white; maximum}")
        self.verticalLayout_5.addWidget(self.lineEdit_submission)
        self.tableWidget = QtWidgets.QTableWidget(parent=self.tab_2)
        self.tableWidget.setStyleSheet("QTableWidget {\n"
"\n"
...
"}")
        ...
        self.toolButton_addbook.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_addbook.setObjectName("toolButton_addbook")
        self.toolButton_addbook.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        # self.lineEdit_bookid.setStyleSheet("QLineEdit {border-width: 1px;border-style: solid; border-color: green; border-radius: 4px;}")
        # self.toolButton_addbook.setStyleSheet("border-style: none;")
        self.verticalLayout.addWidget(self.toolButton_addbook)
        ...
        self.toolButton_addmember.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_addmember.setObjectName("toolButton_addmember")
        self.toolButton_addmember.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        self.verticalLayout.addWidget(self.toolButton_addmember)
        ...
        self.toolButton_viewbook.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_viewbook.setObjectName("toolButton_viewbook")
        self.toolButton_viewbook.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        self.verticalLayout.addWidget(self.toolButton_viewbook)
        ...
        self.toolButton_viewmember.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_viewmember.setObjectName("toolButton_viewmember")
        self.toolButton_viewmember.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        self.verticalLayout.addWidget(self.toolButton_viewmember)
        self.horizontalLayout.addLayout(self.verticalLayout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Library Management System"))
        self.lineEdit_bookid.setPlaceholderText(_translate("MainWindow", "Please Enter Book ID"))
        self.label_bookname_2.setText(_translate("MainWindow", "Book Name:"))
        self.label_bookauthor_2.setText(_translate("MainWindow", "Book Author:"))
        self.lineEdit_memberid.setPlaceholderText(_translate("MainWindow", "Please Enter Member ID"))
        self.label_membername_2.setText(_translate("MainWindow", "Member Name:"))
        self.label_contactinfo_2.setText(_translate("MainWindow", "Contact Info:"))
        self.toolButton_issue.setText(_translate("MainWindow", "Issue Book"))
        self.toolButton_issue.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Issue Book"))
        self.lineEdit_submission.setPlaceholderText(_translate("MainWindow", "Please Enter Book ID"))
        ...
        item.setText(_translate("MainWindow", "Renew Count"))
        self.toolButton_renew.setText(_translate("MainWindow", "Renew Book"))
        self.toolButton_renew.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        
        self.toolButton_submitbook.setText(_translate("MainWindow", "Submit Book"))
        self.toolButton_submitbook.setStyleSheet("QToolButton { border-width: 1px;border-style: solid; border-color: green; border-radius: 4px; background-color: white}")
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Renew/Submission Book"))
